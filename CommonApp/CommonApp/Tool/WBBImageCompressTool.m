//
//  WBBImageCompressTool.m
//  CommonApp
//
//  Created by 斌 on 2018/12/14.
//  Copyright © 2018 binbin. All rights reserved.
//

#import "WBBImageCompressTool.h"

@implementation WBBImageCompressTool
                                     ...
                                     block:(DataBlock)DataBlock
{
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        NSData *newIMGData = [WBBImageCompressTool CompressToDataWithImage:OldImage
                                                                 ShowSize:ShowSize
                                                                 FileSize:FileSize];
...
{
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        UIImage *newIMG = [WBBImageCompressTool CompressToImageWithImage:OldImage
                                                               ShowSize:ShowSize
                                                               FileSize:FileSize];
        ImgBlock(newIMG);
    });
